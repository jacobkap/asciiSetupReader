...
This is a vector of strings with the column name (can be either the name in col_names or col_labels but musy be consistent) followed by all the values that represent missing values, each in its own string. 
