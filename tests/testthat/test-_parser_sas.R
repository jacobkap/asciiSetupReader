...
#   expect_silent(parse_setup(parole_survey_sas_name))
...
#                                                             3752, 3756, 3757, 3758))
#
#   expect_equal(head(ncvs_parsed_sas$setup$begin), c(1, 7, 10, 12, 15, 19))
#   expect_equal(tail(ncvs_parsed_sas$setup$begin), c(713, 717, 719, 727, 729, 731))
#
#
#   expect_equal(head(jail_1987_parsed_sas$setup$begin), c(1, 5, 6, 7, 10, 13))
#   expect_equal(tail(jail_1987_parsed_sas$setup$begin), c(633, 634, 636, 638, 640, 642))
#
#
#   expect_equal(head(jail_2010_parsed_sas$setup$begin), c(1, 22, 31, 33, 78, 123))
#   expect_equal(tail(jail_2010_parsed_sas$setup$begin), c(1125, 1127, 1133, 1135, 1141, 1143))
#
#   expect_equal(corrections_parsed_sas$setup$begin, c(1, 2, 6, 8, 9, 10, 11,15, 19, 23, 27, 28, 30, 31))
#
#
# })
#
...
#
#
#   expect_equal(weimar_parsed_sas$setup$end, c(2, 4, 5, 22, 29, 36, 43, 50, 57, 64, 71, 78,
